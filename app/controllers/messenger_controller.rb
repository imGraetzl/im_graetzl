class MessengerController < ApplicationController
  ...
  def start_thread
    ...
    if !(current_user.admin? || current_user.trust_level_at_least?(:trusted)) && current_user.user_message_threads.where(created_at: 45.minutes.ago..Time.current).count >= 15
      # Spam Filter
