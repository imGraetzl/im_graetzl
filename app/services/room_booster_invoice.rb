class RoomBoosterInvoice
  ...
  def add_room_booster_info(pdf, room_booster)
    ...
    table_data << [room_booster.id, room_booster.room_offer.to_s.gsub!(/[^0-9A-Za-z]/, ' '), room_booster.runtime, room_booster.region.name.to_s, room_booster.basic_price_with_currency]
