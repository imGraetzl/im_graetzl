module ImagesHelper
  ...
  def stock_photo(opt)
    ...
    if Rails.application.assets[alpha_img].blank? && Rails.application.asset_manifest.assets[alpha_img].blank?
  ...
  def stock_avatar(model, opt)
    ...
    if Rails.application.assets[default_img].blank? && Rails.application.asset_manifest.assets[alpha_img].blank?
