class CrowdCampaign < ApplicationRecord
  ...
  string_enum boost_status: ["boost_request", "boost_declined", "boost_approved", "boost_authorized", "boost_debited", "boost_cancelled"]
  ...
  scope :guest_newsletter, -> {funding.region_or_platform.where(guest_newsletter: true).order(enddate: :asc)}
