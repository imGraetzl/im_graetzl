class CrowdBoostCharge < ApplicationRecord
  ...
  enum :payment_status, { incomplete: "incomplete", authorized: "authorized", processing: "processing", debited: "debited", disputed: "disputed", failed: "failed", refunded: "refunded" }
