...
ActiveRecord::Schema.define(version: 20160330124401) do
  ...
  add_index "operating_ranges", ["operator_id", "operator_type"], name: "index_operating_ranges_on_operator_id_and_operator_type", using: :btree
